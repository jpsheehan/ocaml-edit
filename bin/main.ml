...
let build_theme () =
  Theme.create (font_location, font_size)
    ~fg:(Color.create ~r:0xff ~g:0xff ~b:0xff ~a:0xff)
    ~bg:(Color.create ~r:0x22 ~g:0x22 ~b:0x22 ~a:0xff)
    ~cursor:(Color.create ~r:0xff ~g:0x99 ~b:0x99 ~a:0xff)
    ~selection:(Color.create ~r:0x55 ~g:0x55 ~b:0x55 ~a:0x88)
